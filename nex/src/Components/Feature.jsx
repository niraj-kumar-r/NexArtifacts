...
function Feature() {
    ...
    return (
        <div id="features" ref={featuresRef}>
            <h1 style={{ fontSize: "2.5rem", color: "#000266", textAlign: "center" }}>Features</h1>

            <div className="a-container">
                <FeatureBox
                    image={featureimage}
                    title={<span style={{ fontSize: "1rem", fontWeight: "bold", color: "#6B90F5" }}>Interactive World Map</span>}
                ...
                <FeatureBox
                    ...
                    title={<span style={{ fontSize: "1rem", fontWeight: "bold", color: "#6B90F5" }}>Street View Integration</span>}
                ...
                <FeatureBox
                    ...
                    title={<span style={{ fontSize: "1rem", fontWeight: "bold", color: "#6B90F5" }}>Artifact Showcase</span>}
                ...
                />
                  <FeatureBox
                    image={featureimage3}
                    title={<span style={{ fontSize: "1rem", fontWeight: "bold", color: "#6B90F5" }}>360-Degree Rotation</span>}
